        ...
        <div className="flex items-center justify-between rounded-3xl border border-slate-100 bg-white px-5 py-4 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            <button className="relative flex h-10 w-10 items-center justify-center rounded-full bg-slate-50 text-slate-700 hover:bg-slate-100">
              <Bell size={20} />
              <span className="absolute right-0 top-0 h-4 min-w-4 rounded-full bg-red-500 px-1 text-[10px] font-bold leading-4 text-white">
                3
              </span>
            </button>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              return (
                <div
                  key={item.label}
                  className={`rounded-2xl border border-slate-100 p-5 shadow-sm ${item.bg}`}
                >
                  <div
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <Link
              ...
              className="rounded-2xl border border-slate-100 bg-slate-50 p-5 text-center transition hover:-translate-y-0.5 hover:shadow-md"
            >
            ...
            <Link
              href="/dashboard/student/new?anonymous=1"
              className="rounded-2xl border border-slate-100 bg-slate-50 p-5 text-center transition hover:-translate-y-0.5 hover:shadow-md"
            >
